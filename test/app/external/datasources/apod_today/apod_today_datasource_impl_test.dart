...
import 'apod_today_datasource_impl_test.mocks.dart';

@GenerateNiceMocks([MockSpec<Http>()])
void main() {
  final http = MockHttp();
  final datasource = ApodTodayDatasourceImpl(http);

  test('Should return a ApodModel if status code equal 200', () async {
    ...
    expect(result, ApodModel.fromJson(mockedResult));
  });
