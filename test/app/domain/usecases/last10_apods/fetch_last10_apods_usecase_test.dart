...
import 'fetch_last10_apods_usecase_test.mocks.dart';

@GenerateNiceMocks([MockSpec<Last10ApodsRepository>()])
void main() {
  final repository = MockLast10ApodsRepository();
  final usecase = FetchLast10ApodsUsecase(repository);

  test('Should return a List<ApodEntity>', () async {
    when(repository.fetchLast10Apods())
  ...
  test('Should return a Failure', () async {
    when(repository.fetchLast10Apods()).thenAnswer(
